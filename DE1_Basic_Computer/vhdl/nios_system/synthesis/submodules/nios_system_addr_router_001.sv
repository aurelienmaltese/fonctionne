...
(
    ...
    localparam PAD3 = log2ceil(64'h8080000 - 64'h8000000); 
    ...
    localparam PAD11 = log2ceil(64'h10000070 - 64'h10000060); 
    localparam PAD12 = log2ceil(64'h10000080 - 64'h10000070); 
    localparam PAD13 = log2ceil(64'h10001008 - 64'h10001000); 
    localparam PAD14 = log2ceil(64'h10001018 - 64'h10001010); 
    localparam PAD15 = log2ceil(64'h10002020 - 64'h10002000); 
    // -------------------------------------------------------
    ...
    // ( 0x8000000 .. 0x8080000 )
    if ( {address[RG:PAD3],{PAD3{1'b0}}} == 29'h8000000   ) begin
    ...
    if ( {address[RG:PAD14],{PAD14{1'b0}}} == 29'h10001010   ) begin
            src_channel = 17'b0010000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 11;
    end

    // ( 0x10002000 .. 0x10002020 )
    if ( {address[RG:PAD15],{PAD15{1'b0}}} == 29'h10002000   ) begin
